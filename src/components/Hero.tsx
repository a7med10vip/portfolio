...
const DISPLAY = "'TAN Headline', var(--font-heading), system-ui, sans-serif";
...
const ROTATING = ["Impact", "Growth", "Digital", "Strategy", "Innovation", "Results"];
    ...
    >
        ...
        >
          ...
          {confetti.map(([x, y, d, c], i) => (
            <span
              ...
              style={{ left: u(x), top: u(y), width: u(d), height: u(d), background: c }}
            />
          ))}
          ...
          >
            <span style={{ ...pillType, fontSize: u(54), color: INK }}>Business Development</span>
          </div>
          {topBadges.map((c) => (
            <div
              key={c.alt}
          ...
          >
            ...
            <svg
              ...
              style={{ right: u(-20), top: u(38), width: u(140), height: u(72) }}
            >
              <defs>
          ...
          <svg
            ...
            viewBox="0 0 80 40"
            style={{ left: u(1040), top: u(CY2 + 64), width: u(80), height: u(40) }}
          >
            <path
          ...
          >
            <div
              ...
              style={{
                ...
                padding: `0 ${u(22)}`,
                gap: u(14),
                boxShadow: `0 ${u(4)} ${u(12)} rgba(0,0,0,0.06)`,
              }}
            >
              <span
                ...
                >
                  <span className="relative inline-flex" style={{ width: u(10), height: u(10) }}>
                    <span
                      ...
                      style={{ background: TEAL_MID, animation: "hero-pulse 1.8s ease-in-out infinite" }}
                    />
          ...
          <svg
            ...
            viewBox="0 0 360 250"
            fill="none"
            style={{ left: u(1140), top: u(CY3 - 12), width: u(360), height: u(250) }}
          >
            <path
      ...
      <div className="lg:hidden relative px-5 sm:px-8 pt-28 pb-14">
        ...
        <div className="relative max-w-[560px] mx-auto">
          {/* availability bubble */}
          <div
            className="hs-anim hs-badge inline-flex items-center gap-2.5 rounded-full pl-2 pr-4 py-2 mb-6"
            style={{ background: MINT }}
          >
            <span className="inline-flex items-center gap-1.5 rounded-full bg-white px-3 py-1.5">
              <span className="relative inline-flex w-2 h-2">
                <span className="absolute inset-0 rounded-full" style={{ background: TEAL_MID, animation: "hero-pulse 1.8s ease-in-out infinite" }} />
                <span className="absolute inset-0 rounded-full" style={{ background: TEAL_MID }} />
              </span>
              <span className="text-[12px] font-bold" style={{ color: INK }}>Open to work</span>
            </span>
            <span className="text-[12px] font-bold" style={{ color: TEAL }}>Jeddah · Remote</span>
          </div>
